...
// Module: np_dpu.v
// Project: NF2.1
// Description: Defines the logic for the multithreaded DPU used in the Network Processor SoC
//
///////////////////////////////////////////////////////////////////////////////
`timescale 1ns/1ps
...
assign   dmem_addr   =  debug? mem_addr_debug[8:0]    :     ex_alu_dout[8:0];                //increased address-space bit one 1 just to account for any future expansions
assign   dmem_datain =  debug? mem_din_debug          :     idex_r2_data_reg;   
assign   mem_dout    =  dmem_dout;
assign   dmem_doutb  =  dmem_dout;
assign   dmem_we     =  debug? dmem_web               :     idex_memwe_reg;
...
/* This part is now removed, since the BRAM Dmem is not present in the Network_memory and we access the data from there.
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
 ...
 generic_regs
   #( 
      ...
      .TAG                 (`NP_DPU_BLOCK_ADDR),          // Tag -- eg. MODULE_TAG
      .REG_ADDR_WIDTH      (`NP_DPU_REG_ADDR_WIDTH),     // Width of block addresses -- eg. MODULE_REG_ADDR_WIDTH
      .NUM_COUNTERS        (0),                 // Number of counters
      .NUM_SOFTWARE_REGS   (5),                 // Number of sw regs
      .NUM_HARDWARE_REGS   (9)                  // Number of hw regs
   ) module_regs (
